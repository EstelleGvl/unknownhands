...
- [Discovering Female Scribes through Data]({{ '/pack1/' | relative_url }})
- [Networks and Cultural Production]({{ '/pack2/' | relative_url }})

The planned *Voices in the Colophon* pack will be added when its materials are ready.
