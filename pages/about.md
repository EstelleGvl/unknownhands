...
<img src="{{ '/assets/img/Laon,BM,Ms.423,f.79v.png' | relative_url }}" alt="Colophon of Dulcia" caption="Laon,BM,Ms.423,f.79v">
...
# Ethics & Care
Unknown Hands is directed by Estelle Guéville (Yale University) with the support of colleagues in manuscript studies and digital humanities. See the [Team page]({{ '/team/' | relative_url }}) for advisors, collaborators, and acknowledgments.

We aim to represent people’s work accurately and respectfully. When records include sensitive details or contested attributions, we document the basis, allow for disagreement, and respond to takedown/correction requests. [Contact us]({{ '/contact/' | relative_url }}) for concerns.
...
See [Contact]({{ '/contact/' | relative_url }}) for how to reach us and [Participate]({{ '/participate/' | relative_url }}) to get involved in the project.
