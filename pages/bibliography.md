...
{% for ref in site.data.bibliography %}
  ...
  {% endif %}
  {% assign primary_key = primary | downcase | slugify: 'latin' %}
  {% assign title_key = ref.title | default: "" | downcase | slugify: 'latin' %}
  {% assign sortkey = primary_key | append: '|' | append: year | append: '|' | append: title_key %}
